...
#include <eurobot2023_main_small/rcake.h>
#include <eurobot2023_main_small/rcherry.h>
#include <eurobot2023_main_small/rrelease.h>
...
public:
    ...
    void updateParams(std_srvs::Empty::Request& req, std_srvs::Empty::Response& res)
    {
        ...
        _cake_client = nh.serviceClient<eurobot2023_main_small::rcake>("rcake"+to_string(robot));
        _cherry_client = nh.serviceClient<eurobot2023_main_small::rcherry>("rcherry"+to_string(robot));
        _release_client = nh.serviceClient<eurobot2023_main_small::rrelease>("rrelease"+to_string(robot));
    ...
    ros::ServiceClient _cake_client = nh.serviceClient<eurobot2023_main_small::rcake>("rcake"+to_string(robot));
    ros::ServiceClient _cherry_client = nh.serviceClient<eurobot2023_main_small::rcherry>("rcherry"+to_string(robot));
    ros::ServiceClient _release_client = nh.serviceClient<eurobot2023_main_small::rrelease>("rrelease"+to_string(robot));
...
int main(int argc, char **argv)
{
    ...
    eurobot2023_main_small::rcake srv;
                ...
                case RELEASE:
                    ...
                    else if (!got_release_point)
                    {
                        if (release.data == 0 || release.data == robot+1)
                        {
                            ...
                            eurobot2023_main_small::rrelease rsrv;
                            rsrv.request.num = 0;
