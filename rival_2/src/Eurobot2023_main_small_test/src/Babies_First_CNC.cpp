...
#include <Eurobot2023_main_small_test/rcake.h>
#include <Eurobot2023_main_small_test/rcherry.h>
#include <Eurobot2023_main_small_test/rrelease.h>
...
public:
    ...
    void updateParams(std_srvs::Empty::Request& req, std_srvs::Empty::Response& res)
    {
        ...
        _release = nh.advertise<std_msgs::Int32>("rrelease"+to_string(robot), 1000);
        _another_release = nh.subscribe<std_msgs::Int32>("rrelease"+to_string(!bool(robot)), 1000, &mainProgram::anothere_callback, this);
        _cake_client = nh.serviceClient<Eurobot2023_main_small_test::rcake>("rcake"+to_string(robot));
        _cherry_client = nh.serviceClient<Eurobot2023_main_small_test::rcherry>("rcherry"+to_string(robot));
        _release_client = nh.serviceClient<Eurobot2023_main_small_test::rrelease>("rrelease"+to_string(robot));
        _where2go = nh.advertise<geometry_msgs::PoseStamped>("/rival"+to_string(robot+1)+"/mission", 1000);
        _finishornot = nh.subscribe<std_msgs::Bool>("/rival"+to_string(robot+1)+"/is_finish", 1000, &mainProgram::nav_callback, this);
        _mission = nh.advertise<std_msgs::String>("rmission"+to_string(robot), 1000);
        _donefullness = nh.subscribe<std_msgs::Int32MultiArray>("rdonefullness"+to_string(robot), 1000, &mainProgram::done_fullness_callback, this);
        _myPos = nh.subscribe<nav_msgs::Odometry>("/rival"+to_string(robot+1)+"/odom", 1000, &mainProgram::myPos_callback, this);
    }
    ...
    // main
    ros::Publisher _ibasket = nh.advertise<std_msgs::Int32>("rbasketornot", 1000);
    ros::Publisher _release = nh.advertise<std_msgs::Int32>("rrelease"+to_string(robot), 1000);
    ros::Publisher _ifinish = nh.advertise<std_msgs::Bool>("rfinishall", 1000);
    ros::Subscriber _basketornot = nh.subscribe<std_msgs::Int32>("rbasketornot", 1000, &mainProgram::basket_callback, this);
    ros::Subscriber _another_release = nh.subscribe<std_msgs::Int32>("rrelease"+to_string(!bool(robot)), 1000, &mainProgram::anothere_callback, this);
    ros::Subscriber _finishall = nh.subscribe<std_msgs::Bool>("rfinishall", 1000, &mainProgram::finishall_callback, this);
    ros::ServiceClient _cake_client = nh.serviceClient<Eurobot2023_main_small_test::rcake>("rcake"+to_string(robot));
    ros::ServiceClient _cherry_client = nh.serviceClient<Eurobot2023_main_small_test::rcherry>("rcherry"+to_string(robot));
    ros::ServiceClient _release_client = nh.serviceClient<Eurobot2023_main_small_test::rrelease>("rrelease"+to_string(robot));

    // chassis
    ros::Publisher _where2go = nh.advertise<geometry_msgs::PoseStamped>("/rival"+to_string(robot+1)+"/mission", 1000);
    ros::Subscriber _finishornot = nh.subscribe<std_msgs::Bool>("/rival"+to_string(robot+1)+"/is_finish", 1000, &mainProgram::nav_callback, this);

    // mission
    ros::Publisher _mission = nh.advertise<std_msgs::String>("rmission"+to_string(robot), 1000);
    ros::Subscriber _donefullness = nh.subscribe<std_msgs::Int32MultiArray>("rdonefullness"+to_string(robot), 1000, &mainProgram::done_fullness_callback, this);
    ros::Subscriber _startornot = nh.subscribe<std_msgs::Bool>("startornot", 1000, &mainProgram::start_callback, this);

    // basket
    ros::Publisher _point_home = nh.advertise<std_msgs::Int32>("rpoint_home", 1000);

    // camera
    ros::Publisher _turnonornot = nh.advertise<std_msgs::Bool>("rturnonornot", 1000);
    ...
    // locate
    ros::Publisher _obstacles = nh.advertise<geometry_msgs::PoseArray>("robstacles", 1000);
    ros::Subscriber _myPos = nh.subscribe<nav_msgs::Odometry>("/rival"+to_string(robot+1)+"/odom", 1000, &mainProgram::myPos_callback, this);
...
int main(int argc, char **argv)
{
    ...
    Eurobot2023_main_small_test::rcake srv;
        ...
        case NORMAL:
            ...
            case RUN:
                if (!printOnce)
                {
                    ...
                    //     cout << "frame_id : " << cake_picked[i].header.frame_id << endl;
                    // }
                    // cout << cakeNum << endl;
                }
                printOnce = true;
                ...
                case RELEASE:
                    ...
                    else if (!got_release_point)
                    {
                        if (release.data == 0 || release.data == robot+1)
                        {
                            ...
                            Eurobot2023_main_small_test::rrelease rsrv;
                            rsrv.request.num = 0;
