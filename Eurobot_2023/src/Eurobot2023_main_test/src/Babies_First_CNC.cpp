...
string id;
string id_frame = "/robot" + to_string(robot) + "/map";
    ...
    while (ros::ok())
    {
        ...
        case NORMAL:
            ...
            case SETUP:
                ...
                mainClass.poseStamped_set(basket_point[0], 0.225, 0.225, 0, 0);
                mainClass.poseStamped_set(basket_point[1], 0.225, 1.775, 0, 0);
